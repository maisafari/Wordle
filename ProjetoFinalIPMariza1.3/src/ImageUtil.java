...
class ImageUtil {
	...
	static int[][] createColorImageWithText(int width, int height, Color backgroundColor, int textX, int textY,
	...
	////
	static int[][] createColorImage(int width, int height, Color backgroundColor, int textX, int textY, boolean isCentered) {
		BufferedImage img = new BufferedImage(width, height, BufferedImage.TYPE_INT_RGB);
